            ...
            <main className="flex flex-col items-center justify-center min-h-screen gap-10">
                ...
                <div className="flex flex-col justify-stretch gap-4">
                    ...
                    <div className="flex justify-between items-center gap-3">
                        ...
                        <input className="bg-zinc-900 px-3 py-2 rounded-lg outline-none w-60" type="password" id="password" placeholder="set password" required/>
                    </div>
                    <div className="flex flex-col items-center justify-between gap-4">
                        ...
                        <a href="/sign-in" target="_blank" className="text-white/30 text-xs italic">sign in</a>
                    </div>
                </div>
            </main>
        </div>
